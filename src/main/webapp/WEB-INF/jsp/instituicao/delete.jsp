...
<div class="page-header">
    <div class="row">
        <div class="col 12">
            <h1><fmt:message key="instituicao.delete" /> <small class="text-muted" style="text-transform: lowercase"><fmt:message key="register" /></small></h1>
        </div>
    </div>
</div>

<div class="row">
    <form class="col s12" action="${linkTo[InstituicaoController].delete}" method="POST">
