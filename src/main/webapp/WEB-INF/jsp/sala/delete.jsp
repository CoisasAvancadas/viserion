...
<div class="page-header">
    <div class="row">
        <div class="col 12">
            <h1><fmt:message key="sala.delete" /> <small class="text-muted" style="text-transform: lowercase"><fmt:message key="register" /></small></h1>
        </div>
    </div>
</div>

<div class="row">
    <form class="col s12" action="<c:url value="/instituicao/${sala.instituicao.id}/sala/apagar/${sala.id}"/>" method="POST">
